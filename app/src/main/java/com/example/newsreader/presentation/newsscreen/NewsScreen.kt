...
import com.example.newsreader.presentation.component.BottomSheetComponent
...
@Composable
fun NewsScreen(state: NewsState, onEvent: (NewsScreenEvent) -> Unit, onReadFullStoryButtonClicked: (String) -> Unit) {
